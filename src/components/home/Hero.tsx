...
export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-[#050b14] pt-32">
      ...
      <div className="relative mx-auto flex max-w-7xl flex-col items-center gap-16 px-6 py-20 lg:flex-row">
        ...
        <div className="flex-1">
          ...
          <h1 className="mt-8 text-5xl font-black leading-none text-white md:text-7xl tracking-tight">
            ALQUIMIA
          ...
          <div className="mt-10 flex flex-wrap gap-4">
            <a
              ...
              className="rounded-xl bg-emerald-600 px-8 py-4 font-bold text-white transition-all duration-300 hover:bg-emerald-500 hover:shadow-[0_0_20px_rgba(16,185,129,0.5)]"
            >
            ...
            <a
              href="#servicios"
              className="rounded-xl border border-cyan-500 px-8 py-4 font-bold text-cyan-300 transition-all duration-300 hover:bg-cyan-500/10 hover:shadow-[0_0_15px_rgba(6,182,212,0.3)]"
            >
              Ver Servicios
            </a>
          </div>
          ...
          <div className="mt-12 grid grid-cols-3 gap-8 border-t border-gray-800 pt-8">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400 mt-1">Equipos reparados</p>
            </div>
            <div>
        ...
        <div className="flex flex-1 justify-center w-full">
          <div className="relative w-full max-w-md aspect-square flex items-center justify-center">
            ...
            {/* Efecto Aura de Neón Detrás */}
            <div className="absolute inset-0 rounded-full bg-cyan-500/10 blur-3xl" />

            <div className="relative w-full h-full rounded-2xl overflow-hidden border border-cyan-500/10 shadow-[0_0_50px_rgba(6,182,212,0.15)]">
              <Image
                src="/hero-console.png"
                alt="Alquimia Digital Servicio Técnico"
                fill
                priority
